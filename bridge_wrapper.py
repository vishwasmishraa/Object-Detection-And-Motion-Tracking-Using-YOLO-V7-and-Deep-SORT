...
class YOLOv7_DeepSORT:
    ...
    def track_videoX(self, video:str, output:str, skip_frames:int=0, show_live:bool=False, count_objects:bool=False, verbose:int = 0):
        ...
        while True: # while video is running
            ...
            if skip_frames and not frame_num % skip_frames: continue
            ...
            # Show live tracking if specified
            if show_live:
            ...
            # Print frame processing information if specified
            if verbose >= 1:
    ...
    def track_video(self,video:str, output:str, skip_frames:int=0, show_live:bool=False, count_objects:bool=False, verbose:int = 0):
        ...
        while True: # while video is running
            ...
            #cv2.imwrite(str(countvariable) + ".jpg",result)
